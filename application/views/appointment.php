                                    ...
                                    <table id="dataTable" class="table table-bordered table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="align-middle">Reason Cancellation</th>
                                        ...
                                        <tbody>
                                            <?php foreach($appointment_list AS $fetch): ?>
                                                <tr>
                                                    ...
                                                    <td><?= ($fetch['reason'] == '') ? 'N/A' : $fetch['reason']; ?></td>
                                                    <td>
                                                        <button 
                                                            ...
                                                            <form method="POST" onsubmit="event.preventDefault(); update_apt_status(<?= $fetch['id'] ?>)">
                                                                ...
                                                                <div class="modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3 ml-3 mr-3">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="form-group mt-2" id="selectBoxField2_<?= $fetch['id'] ?>">
                                                                            <!-- <label for="comment">Comment</label>
                                                                            <textarea class="form-control" name="comment"></textarea> -->
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <form method="POST" onsubmit="event.preventDefault(); update_appointment(<?= $fetch['id'] ?>)">
                                                                ...
                                                                <div class="modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3 ml-3 mr-3">
                                                                    ...
                                                                    <div class="form-group mt-2">
                                                                        ...
                                                                        <input type="text" id="up_service_<?= $fetch['id'] ?>" name="service" value="<?= htmlspecialchars($fetch['service']) ?>" class="form-control" disabled>
