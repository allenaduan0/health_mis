<!DOCTYPE html>
    ...
    <?php
            ...
            <div class="mb-5 shadow card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 text-danger ">
                        <span> Please make sure all fields are filled in correctly </span> <br/><br/>
                        
                    </div>
                    <!-- <div class="form-row"> -->
                        <input type="checkbox" id="terms_box"/> By checking this checkbox, You agree with our <a href='#' style='color:blue' data-toggle="modal" data-target="#languageModal">Terms and Conditions</a>
                    <!-- </div> -->
                    <div class="form-group ">
                        <button class="mt-3 btn btn-primary" type="submit" id="register_btn" name="submit" disabled>Register</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button class="btn btn-primary" onclick="showEnglishModal(1)">English</button>
                        <button class="btn btn-primary" onclick="showTagalogModal(2)">Tagalog</button>
                    </div>
        ...
        <!-- Tagalog modal -->
        <div class="modal" id="tagalogModal">
            <div class="modal-dialog">
                <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title">Mga Tuntunin at Kundisyon</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>

                    <!-- Modal Body -->
                    <div class="modal-body">
                        <!-- <p>Ito ang nilalaman sa Tagalog.</p> -->
                    </div>

                    <!-- Modal Footer -->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Sumasang ayon ako</button>
                    </div>
