                    ...
                    >
                        ...
                        <div class="mt-3 text-danger ">
                            ...
                            <div style="float:right">
                                <?php foreach($walkin AS $walk): ?>
                                    Number of Walk-In Accepted : <input type="text" id="walkin_count" onblur="update_walkin()" style="width:50px" value="<?= $walk['walk_in_accepted']; ?>"/> <br/>
                                <?php endforeach; ?>
                                <p style='color:red'>Number of Walk-In Left: <b style='color:green'><?= $count_left; ?></b></p>
                            </div>
                        </div>
                        <div class="form-group ">
