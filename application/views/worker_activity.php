            ...
            <div class="d-flex flex-column" id="content-wrapper">
                ...
                <div class="content">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light top-header">
                        ...
                        <h5 class="navbar-header-text">My activities</h5>
                    ...
                    <div class="container-fluid-settings">
                        <div class="shadow card">
                            <div class="py-3 card-header">
                                <p class="m-0 text-primary font-weight-normal">Generate activities</p>
                            </div><div class="card-body">
                                <?php $form_attributes = array("class" => "mt-2 row g-3") ?>
                                <?php echo form_open('Main_Controller/dummy_worker_generator', $form_attributes); ?>
                                <!-- <form class="mt-2 row g-3" method="POST" action='userActivityResult.php'> -->
                                    <div class="col-auto">
                                        <label for="staticEmail2">From:</label>
                                    </div>
                                    <div class="col-auto">
                                        <input type="date" class="form-control" name="wo_startdate">
                                    </div>
                                    <div class="col-auto">
                                        <label for="staticEmail2">To:</label>
                                    </div>
                                    <div class="col-auto">
                                        <input type="date" class="form-control" name="wo_enddate">
                                    </div>
                                    <div class="col-auto">
                                        <button type="submit" class="mb-3 btn btn-primary" name="searchreportdate">Generate</button>
                                    </div>
                                <?php echo form_close(); ?>
                                <!-- </form> -->
                            </div>
