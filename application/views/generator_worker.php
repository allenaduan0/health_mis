            ...
            <div class="d-flex flex-column" id="content-wrapper">
                ...
                <div class="content">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light top-header">
                        ...
                        <h5 class="navbar-header-text">User Activity</h5>
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="mt-4 table-responsive">
                                            <table id="dataTable" class="table table-bordered table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                    <?php foreach($worker_generator AS $fetch): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a role="button" class="btn btn-info text-light btn-sm" data-toggle="modal" href="#view-apt<?= $fetch['id']; ?>" data-toggle-title="tooltip" data-placement="bottom" title="View Information">
