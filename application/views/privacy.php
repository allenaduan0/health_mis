            ...
            <div class="d-flex flex-column" id="content-wrapper">
                ...
                <div class="content">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light top-header">
                        ...
                        <h5 class="navbar-header-text">Privacy List </h5>
                    ...
                    <div class='add_user-class'> 
                        ...
                        <div class="shadow card">
                            ...
                            <div class="py-3 card-header">
                                <p class="m-0 text-primary font-weight-normal">System Privacy List </p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php foreach($get_privacy AS $fetch): ?>
                                                <tr>
                                                    <td><?= $fetch['id'] ?></td>
                                                ...
                                                ?>
                                                <div class="modal fade" id="update_modal<?= $fetch['id'] ?>" aria-hidden="true" tabindex="-1" aria-labelledby="update_modal">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class=" modal-content bg-light">
                                                            <form method="POST" onsubmit="event.preventDefault(); update_privacy(<?= $fetch['id'] ?>)">
                                                                ...
                                                                <div class="ml-3 mr-3 modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3">
                                                                    <div class="col">
                                                                        ...
                                                                        <!-- <div class="mt-2 form-group">
                                                                            <label for="vaccine_qty">Quantity </label>
                                                                            <input class="form-control" id="vaccine_qty" name="vaccine_qty" required="required" placeholder="Enter Quantity"/>
