...
<!DOCTYPE html>
    ...
    <div class="navbar-title" ><a href="../dashboard.php">HEALTH CENTER MANAGEMENT SYSTEM</a></div>
        <div class="wrapper ">
            ...
            $('row:first c', sheet).attr('s', '42'); // Add styling to first row

            // Add logo image
            var img = '<xdr:twoCellAnchor xmlns:xdr="http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing">' +
                '<xdr:from><xdr:col>0</xdr:col><xdr:colOff>0</xdr:colOff><xdr:row>0</xdr:row><xdr:rowOff>0</xdr:rowOff></xdr:from>' +
                '<xdr:to><xdr:col>2</xdr:col><xdr:colOff>0</xdr:colOff><xdr:row>1</xdr:row><xdr:rowOff>0</xdr:rowOff></xdr:to>' +
                '<xdr:pic><xdr:nvPicPr><xdr:cNvPr id="0" name="Picture" descr="logo"/><xdr:cNvPicPr><a:picLocks noChangeAspect="1" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"/></xdr:cNvPicPr></xdr:nvPicPr><xdr:blipFill><a:blip r:embed="rId1" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"/><a:stretch><a:fillRect xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"/></a:stretch></xdr:blipFill><xdr:spPr><a:xfrm><a:off x="0" y="0"/><a:ext cx="30000" cy="30000"/></a:xfrm><a:prstGeom prst="rect"><a:avLst xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"/></a:prstGeom></xdr:spPr></xdr:pic><xdr:clientData/></xdr:twoCellAnchor>';
