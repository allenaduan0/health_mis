                                                                ...
                                                                <div class="ml-3 mr-3 modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="mt-2 form-group">
                                                                            ...
                                                                            <input class="form-control" id="ser_upt_name" name="ser_upt_name" required="required" value="<?= $fetch['name'] ?>"/>
                                                                               
                                                                        </div>

                                                                        <div class="mt-2 form-group">
                                                                            <label for="ser_apt_price">Price </label>
                                                                            <input class="form-control" id="ser_apt_price" name="ser_apt_price" required="required" value="<?= $fetch['price'] ?>"/>
