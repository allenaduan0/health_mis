<!DOCTYPE html>
    ...
    <body>
                        ...
                        <div class="shadow card">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="mt-4 table-responsive">
                                            ...
                                            <caption><img src="<?= BASE_URL ?>assets/img/logo.png" alt="Table Header Image" width="100" height="100"></caption>
                                                <thead>
                                                    <tr>
                                                        <th colspan="3">
                                                            <img src="<?= BASE_URL ?>assets/img/logo.png" alt="Table Header Image" id="tableHeaderImage" style="display: none;">
                                                        </th>
                                                    </tr>
                                                    <tr>
        ...
        <script>
            document.getElementById('tableHeaderImage').style.display = 'block';
            $('#dataTable').dataTable({
                processing: true,
                // serverSide: true,
