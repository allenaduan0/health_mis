                                                            ...
                                                            <form method="POST" onsubmit="event.preventDefault(); update_appointment(<?= $fetch['id'] ?>)">
                                                                ...
                                                                <div class="modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3 ml-3 mr-3">
                                                                    ...
                                                                    <div class="form-group mt-2">
                                                                        ...
                                                                        <select class="form-control placeholder" id="up_service_<?= $fetch['id'] ?>" name="service" required="required" disabled>
                                                                            <option value="">Select service</option>
                                                                            <option value="Behavioral Counseling" <?php if ($fetch['service'] == "Behavioral Counseling") echo "selected" ?>>Behavioral Counseling</option>
                                                                            <option value="Dietary Counseling" <?php if ($fetch['service'] == "Dietary Counseling") echo "selected" ?>>Dietary Counseling</option>
                                                                            <option value="Diagnostic and Therapeutic Services" 
                                                                            <?php if ($fetch['service'] == "Diagnostic and Therapeutic Services") echo "selected" ?>>Diagnostic and Therapeutic Services
                                                                            </option>
                                                                            <option value="Emergency Care" <?php if ($fetch['service'] == "Emergency Care") echo "selected" ?>>Emergency Care</option>
                                                                            <option value="Dental care" <?php if ($fetch['service'] == "Dental care") echo "selected" ?>>Dental care</option>
                                                                            <option value="Wellness and Preventive Care" <?php if ($fetch['service'] == "Wellness and Preventive Care") echo "selected" ?>>Wellness and Preventive Care</option>
                                                                            <option value="Laboratory" <?php if ($fetch['service'] == "Laboratory") echo "selected" ?>>Laboratory</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group mt-2">
