                                                ...
                                                <div class="modal fade" id="update_modal<?= $fetch['service_id'] ?>" aria-hidden="true" tabindex="-1" aria-labelledby="update_modal">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class=" modal-content bg-light">
                                                            <form method="POST" onsubmit="event.preventDefault(); update_service(<?= $fetch['service_id'] ?>)">
                                                                ...
                                                                <div class="ml-3 mr-3 modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="mt-2 form-group">
                                                                            <label for="ser_upt_name"> Service Name </label>
                                                                            <input class="form-control" id="ser_upt_name_<?= $fetch['service_id'] ?>" name="ser_upt_name" required="required" value="<?= $fetch['name'] ?>"/>
                                                                            <input type="hidden" id="ser_apt_id_<?= $fetch['service_id'] ?>" value="<?= $fetch['service_id'] ?>"/>
                                                                        </div>

                                                                        <div class="mt-2 form-group">
                                                                            <label for="ser_apt_price">Price </label>
                                                                            <input class="form-control" id="ser_apt_price_<?= $fetch['service_id'] ?>" name="ser_apt_price" required="required" value="<?= $fetch['price'] ?>"/>
