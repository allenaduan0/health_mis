    ...
    <body>
        ...
        <script>
            $('#dataTable').dataTable({
                ...
                // Add a logo to the top left corner of the PDF
                var imgData = '../assets/logo.png'; // Replace with your logo's path
                doc.image(imgData, 10, 10, 40, 40); // (image path, x, y, width, height)

                // Modify other PDF properties as needed
                doc.content[1].margin = [10, 50, 10, 10]; // Adjust margins
                doc.content[1].alignment = 'left'; // Set alignment to left
            }
                    }, 
                    {
                        extend: 'print',
