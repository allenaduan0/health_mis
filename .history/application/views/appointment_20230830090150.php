                                                                ...
                                                                <div class="modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3 ml-3 mr-3">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="form-group mt-2">
                                                                            ...
                                                                            <select class="form-control placeholder" id="apt_stat_update_<?= $fetch['id'] ?>" name="apt_stat_update" required="required">
                                                            ...
                                                            <form method="POST" onsubmit="event.preventDefault(); update_appointment(<?= $fetch['id'] ?>)">
                                                                ...
                                                                <div class="modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3 ml-3 mr-3">
                                                                    ...
                                                                    <div class="form-group mt-2">
                                                                        ...
                                                                        <select class="form-control placeholder" id="up_service_<?= $fetch['id'] ?>" name="service" required="required" value="<?= $fetch['service'] ?>">
