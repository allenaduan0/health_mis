...
function update_privacy(id){
    // var privacy_text = $("#privacy_text"+id)

    var textarea = document.getElementById('privacy_text'+id);

    // Get the value of the textarea
    var textareaValue = textarea.value.trim();

    $.ajax({
        url: base_url + "Main_Controller/update_privacy",
        type: "POST",
        data: {
            id:id,
